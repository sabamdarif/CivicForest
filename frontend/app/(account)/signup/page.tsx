...
export const metadata: Metadata = {
  title: "Sign Up",
  description: "Create your CivicForest account.",
};

const SIGNUP_FEATURES: Feature[] = [
...
export default function SignupPage() {
  return (
    <>
      <div className="grid md:grid-cols-2">
        <div className="relative hidden overflow-hidden bg-charcoal text-cream md:block">
          ...
          <div className="relative z-10 flex h-full flex-col items-center justify-center px-10 text-center">
            ...
            <h2 className="mt-5 font-serif text-4xl">Join CivicForest</h2>
            <p className="mt-1 font-serif text-2xl text-gold">Style with purpose.</p>
            <div className="rule-leaf my-5">
              <LeafIcon className="h-4 w-4" />
            </div>
            <p className="max-w-xs text-sm text-cream/70">
              Create an account to save your wishlist, track orders, and design your own prints.
            </p>
          </div>
        </div>
      ...
      <FeatureStrip features={SIGNUP_FEATURES} />
    </>
  );
}
