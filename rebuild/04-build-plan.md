...
4. [x] Build the login page to match the screenshot: split layout, brand imagery left, form right, email
...
14. [x] Tests: tampered totals rejected · coupon reuse past `per_user_limit` rejected · concurrent checkout
